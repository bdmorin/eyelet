...
class TemplateCard(Static):
    ...
    def render_card(self) -> str:
        ...
        tags = (
            " ".join([f"#{tag}" for tag in self.template.tags])
...
class TemplatesScreen(Screen):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.template_service = TemplateService(FileTemplateRepository(templates_dir))
    ...
    def load_templates(self) -> None:
        ...
        try:
            ...
            self.app.call_from_thread(
                self.update_status, f"Loaded {len(self.templates)} templates", "success"
            )
        except Exception as e:
            self.app.call_from_thread(
                self.update_status, f"Failed to load templates: {e}", "error"
            )
    ...
    def action_create_template(self) -> None:
        ...
        self.app.notify(
            "➕ Template creation wizard coming soon!", severity="information"
        )
