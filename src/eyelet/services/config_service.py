...
class ConfigService:
    ...
    def __init__(self, project_dir: Optional[Path] = None):
        ...
        self._global_config: Optional[EyeletConfig] = None
        self._project_config: Optional[EyeletConfig] = None
        self._merged_config: Optional[EyeletConfig] = None
    ...
    def load_project_config(self) -> Optional[EyeletConfig]:
